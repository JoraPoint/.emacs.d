...
Check if local revision exists or remote file has changed if path is configured for deployment." t nil)
...
Open current relative path on remote host in `eshell' but only if it's configured for deployment." t nil)

(autoload 'ssh-deploy-remote-terminal-eshell-base-handler "ssh-deploy" "\
Open base path on remote host in `eshell' but only if it's configured for deployment." t nil)
...
Open current relative path on remote host in `dired-mode' if it is configured for deployment." t nil)

(autoload 'ssh-deploy-browse-remote-base-handler "ssh-deploy" "\
Open base path on remote host in `dired-mode' if it is configured for deployment." t nil)
