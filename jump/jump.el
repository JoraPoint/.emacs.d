...
(defun jump-epsilon-one-element() "jump to element" (interactive) (bookmark-jump "1"))
(global-set-key  (kbd "C-o 1") 'jump-eplison-one-element)
(defun jump-epsilon-two-element() "jump to element" (interactive) (bookmark-jump "2"))
(global-set-key  (kbd "C-o 2") 'jump-epsilon-two-element)
(defun jump-epsilon-third-element() "jump to element" (interactive) (bookmark-jump "3"))
(global-set-key  (kbd "C-o 3") 'jump-eplison-third-element)
(defun jump-epsilon-four-element() "jump to element" (interactive) (bookmark-jump "4"))
(global-set-key  (kbd "C-o 4") 'jump-mega-element)
